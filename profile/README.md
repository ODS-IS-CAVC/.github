<img src="https://github.com/ODS-IS-CAVC/.github/blob/main/images/ODS_Logo.png" width="60%">

## Open Data Spaces 自動運転支援道データ連携基盤 関連リポジトリ
...
「Connected Autonomous Vehicle Corridors（CAVC）（自動運転支援道データ連携基盤）」インダストリサービスでは、自動運転支援道データ連携基盤を実装するための各種ライブラリやツール類を共創しています。

インダストリサービスの関連リポジトリは、[こちら](https://github.com/orgs/ODS-IS-CAVC/repositories)から。
